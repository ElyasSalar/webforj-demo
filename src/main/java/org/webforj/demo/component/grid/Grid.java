 ...
 */
@NodeName("dwc-grid")
@JavaScript(value = "/basis/grid/dwc-grid.js", top = true, attributes = {
...
public class Grid extends ElementComposite
	 ...
	 *
	 * @param grid the grid options to configure the grid behavior and appearance.
	 * @return the current {@code Grid} instance for method chaining.
	 */
	public Grid setOptions(Object grid) {
		set(this.optionsProp, grid);
		return this;
	}
